...
using LMWidgets;
using UnityEditor;
public class ShelfScript_room1 : ButtonToggleBase {
	...
	public override void displayObject() {
		...
		if (myflag == 0) {
			...
			newObj.AddComponent<FetchCloud_shelf> ();
			AssetDatabase.Refresh();
			while(EditorApplication.isCompiling);
			AssetDatabase.ImportAsset("Assets/Resources/shelf1");
			...
			GameObject myobj = Instantiate (Resources.Load ("shelf1")) as GameObject;
