...
public class FetchCloud_table : MonoBehaviour {
	...
	IEnumerator Start () {
		...
		var url = "http://purduemechatronics.com/sarkar/table2.prefab";
		...
		System.IO.File.WriteAllBytes("/Users/jhalakpatel/Desktop/568_OculusLeapMotion_PinchPerfect/Assets/Resources/table2.prefab", data);
		#endif
		print("File written");
