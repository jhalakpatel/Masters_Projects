...
public class TableScript_room1 : ButtonToggleBase {
	...
	public override void displayObject() {
		...
		if (myflag == 0) {
			...
			newObj.AddComponent<FetchCloud_table> ();
			AssetDatabase.Refresh();
			while(EditorApplication.isCompiling);
			AssetDatabase.ImportAsset("Assets/Resources/table2");
			...
			GameObject myobj = Instantiate (Resources.Load ("table2")) as GameObject;
			//print("After");
			...
			myobj.transform.position = new Vector3 (x, 1, z);
