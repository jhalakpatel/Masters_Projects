...
public class FetchCloud_shelf : MonoBehaviour {
	...
	IEnumerator Start () {
		...
		var url = "http://purduemechatronics.com/sarkar/shelf1.prefab";
		...
		System.IO.File.WriteAllBytes("/Users/jhalakpatel/Desktop/568_OculusLeapMotion_PinchPerfect/Assets/Resources/shelf1.prefab", data);
		#endif
		print("File written");
