...
public class DeskScript_room1 : ButtonToggleBase {
	...
	public override void displayObject() {
		...
		if (myflag == 0) {
			...
			newObj.AddComponent<FetchCloud_desk> ();
			AssetDatabase.Refresh();
			while(EditorApplication.isCompiling);
			AssetDatabase.ImportAsset("Assets/Resources/desk2");
			...
			GameObject myobj = Instantiate (Resources.Load ("desk2")) as GameObject;
