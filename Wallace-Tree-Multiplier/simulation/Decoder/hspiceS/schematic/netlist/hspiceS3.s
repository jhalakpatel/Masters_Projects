...
"/home/ecegrid/a/559mg3/cadence/simulation/Decoder/hspiceS/schematic/marchFile")
set @dummy=sdsfun(1201,"/home/ecegrid/a/559mg3/cadence/simulation/Decoder/hspiceS/schematic/netlist")
use /package/eda/cadence/IC5141.151/tools.lnx86/dfII//etc/cdsSpice/dotS/rnfuncs
print
print "simBegin( )"
altqual off
altqual /home/ecegrid/a/559mg3/cadence/simulation/Decoder/hspiceS/schematic/netlist /package/eda/cells/ncsu-cdk-1.5.1/local/models/hspice/public/ /package/eda/cadence/IC5141.151/tools.lnx86/dfII//etc/cdsSpice/dotS
...
"../psf")
print "commandNoSaveBegin( 39 )"
go hspice
print
print "commandNoSaveEnd( 39 )"
print
print "commandSaveBegin( 40 )"
print nogo
print "commandSaveEnd( 40 )"
#                          Welcome to cdsSpice 5.1         
#cdsSpice: 
# 
#simBegin( )
#commandNoSaveBegin( 39 )
...
set @dummy=sdsfun(1205,"CDSPSF","psfdir",&
"../psf")
print "commandNoSaveBegin( 41 )"
go hspice
print
print "commandNoSaveEnd( 41 )"
print
print "commandSaveBegin( 42 )"
print nogo
print "commandSaveEnd( 42 )"
#commandNoSaveBegin( 41 )
# THE CIRCUIT TEMPERATURE IS:    25.0000    
#  HSPICE EXECUTION
###>info:         ***** hspice job concluded
#  HSPICE FINISHED
...
set @dummy=sdsfun(1205,"CDSPSF","psfdir",&
"../psf")
print "commandNoSaveBegin( 43 )"
go hspice
print
print "commandNoSaveEnd( 43 )"
print
print "commandSaveBegin( 44 )"
print nogo
print "commandSaveEnd( 44 )"
#commandNoSaveBegin( 43 )
# THE CIRCUIT TEMPERATURE IS:    25.0000    
#  HSPICE EXECUTION
###>info:         ***** hspice job concluded
#  HSPICE FINISHED
...
set @dummy=sdsfun(1205,"CDSPSF","psfdir",&
"../psf")
print "commandNoSaveBegin( 45 )"
go hspice
print
print "commandNoSaveEnd( 45 )"
print
print "commandSaveBegin( 46 )"
print nogo
print "commandSaveEnd( 46 )"
#commandNoSaveBegin( 45 )
# THE CIRCUIT TEMPERATURE IS:    25.0000    
#  HSPICE EXECUTION
###>info:         ***** hspice job concluded
###real 1.84
